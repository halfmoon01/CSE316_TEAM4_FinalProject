...
const MyInformation = () => {
  ...
  return (
    <div className="myInfo-container">
      ...
      <img src={profileImageUrl || UserIcon} className="profile-image" alt="Profile" />
      <button className="change-button" onClick={() => setIsImageOpen(true)}>
        Change Image
      </button>
    </div>
  </div>
  ...
  <div className="info-grid">
    <div className="info-card">
      ...
      <button className="change-button" onClick={() => setIsNameOpen(true)}>Edit</button>
    </div>
    <div className="info-card">
      <p className="info-label">Email</p>
      <p className="info-value">{email}</p>
      <button className="change-button" onClick={() => setIsEmailOpen(true)}>Edit</button>
    </div>
    <div className="info-card">
      <p className="info-label">Phone</p>
      <p className="info-value">{phoneNumber}</p>
      <button className="change-button" onClick={() => setIsPhoneOpen(true)}>Edit</button>
    </div>
    <div className="info-card">
      <p className="info-label">Password</p>
      <p className="info-value">•••••••</p>
      <button className="change-button" onClick={() => setIsPwdOpen(true)}>Edit</button>
    </div>
    <div className="info-card">
